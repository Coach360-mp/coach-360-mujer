  ...
  const signInWithGoogle = async () => {
    ...
    try {
      await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: `${window.location.origin}/general`,
        },
      })
    } catch (err) {
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 480, textAlign: 'center' }}>
        ...
        <h1 style={{
          ...
          Hábitos,<br />propósito,<br />
          <span style={{ fontStyle: 'italic', color: '#14b8a6' }}>resultados.</span>
        </h1>
        ...
        <p style={{
          ...
          Tu desarrollo personal con método. Conversaciones diarias con Leo, tu mentor estratégico con IA.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 11, color: '#14b8a6', marginBottom: 2, textTransform: 'uppercase', letterSpacing: 1 }}>
              Tu coach
            </div>
            <div style={{ fontSize: 18, fontFamily: 'Georgia, serif', fontWeight: 500, marginBottom: 4 }}>
              Leo, el Mentor Estratégico
            </div>
            <div style={{ fontSize: 12, color: '#a8a8a8', lineHeight: 1.4 }}>
              Directo, desafiante, enfocado en acción. Te acompaña a construir los hábitos que cambian todo.
            </div>
          </div>
        </div>
