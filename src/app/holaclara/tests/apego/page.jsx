...
const TEST = {
  ...
  desc: 'Tu estilo de apego explica más de tus relaciones que cualquier otra cosa. Y se puede cambiar.',
  duracion: '6 min',
  plan: 'Esencial',
  imagen: '/images/test_apego_portada.png',
  metodologia: 'Basado en la teoría del apego de Bowlby y Ainsworth, actualizada por investigación contemporánea.',
  chatMsg: 'Clara, hice el test de estilo de apego. Quiero hablar de lo que encontré sobre cómo me relaciono.',
  preguntas: [
    { texto: 'Me preocupa que las personas que quiero se alejen de mí.', dir: 'ans' },
    { texto: 'Me cuesta pedir ayuda aunque la necesite.', dir: 'evi' },
    { texto: 'En los conflictos, tiendo a buscar resolución rápida aunque sea incómoda.', dir: 'seg' },
    { texto: 'A veces siento que amo más de lo que me aman.', dir: 'ans' },
    { texto: 'Prefiero no depender emocionalmente de nadie.', dir: 'evi' },
    { texto: 'Puedo expresar lo que necesito sin sentir que es demasiado.', dir: 'seg' },
    { texto: 'Los silencios o la distancia de alguien me generan ansiedad.', dir: 'ans' },
    { texto: 'Las relaciones íntimas me generan incomodidad aunque las desee.', dir: 'evi' },
  ],
  perfiles: [
    { nombre: 'Apego ansioso', interpretacion: 'Amas con intensidad. Y eso es una fortaleza — hasta que el miedo a perder empieza a dirigir. La ansiedad de apego no significa que amas mal. Significa que aprendiste a amar en condiciones que no eran seguras.', pregunta: '¿Qué necesitarías sentir en una relación para no tener miedo de perderla?', min: 0, max: 40 },
    { nombre: 'Apego evitativo', interpretacion: 'Valoras tu independencia. Y también te cuesta recibir. El apego evitativo no es falta de amor — es un mecanismo aprendido para protegerte. El problema es que también te protege de lo que más quieres.', pregunta: '¿Cuándo fue la última vez que dejaste que alguien te cuidara de verdad?', min: 41, max: 65 },
    { nombre: 'Apego seguro', interpretacion: 'Puedes amar sin perderte. Pedir sin miedo. Alejarte sin huir. Eso no es suerte — es algo que construiste o que tuviste la fortuna de aprender. Y se puede profundizar.', pregunta: '¿Qué te enseñaron tus relaciones más seguras sobre cómo mereces ser tratada?', min: 66, max: 100 },
  ],
}
